...
function reverseUnicodeVariant(str) {
    const ranges = [
        // [start, end, base code, isUpperCase]
        ...
        [0x1D7CE, 0x1D7D7, 0x30], // bold 0–9
        [0x1D7E2, 0x1D7EB, 0x30], // sans bold 0–9
        [0x1D7EC, 0x1D7F5, 0x30], // sans italic 0–9
        [0x1D7F6, 0x1D7FF, 0x30], // monospace 0–9
    ...
    return [...str].map(char => {
        ...
        // Strip common combining diacritics (underline, strike)
        if (code === 0x0332 || code === 0x0336 || code === 0x035F) {
            return ''; // remove underline/strike
        }
